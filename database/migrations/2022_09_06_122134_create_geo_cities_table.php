 ...
 * @Project: SadeemGeo.
 * @FileName: 2022_09_06_122134_create_geo_cities_table.php.
 ******************************************************************************/
...
return new class extends Migration {
    ...
    public function morph(Blueprint $table): void
    {
        ...
        if (!Schema::hasColumn($tableName, 'geo_city_id')){$table->unsignedInteger("geo_city_id")->unique()->index();}
        ...
        if (!Schema::hasColumn($tableName, 'is_capital_city')){$table->boolean("is_capital_city")->default(0)->index();}
    ...
    public function down(): void
    {
        ...
        Schema::table($tableName, function (Blueprint $table) use ($tableName) {
            if (Schema::hasColumn($tableName, 'geo_city_id')) {$table->dropColumn('geo_city_id');}
            ...
            if (Schema::hasColumn($tableName, 'is_capital_city')) {$table->dropColumn('is_capital_city');}
