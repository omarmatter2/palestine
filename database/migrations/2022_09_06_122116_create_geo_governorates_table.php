 ...
 * @Project: SadeemGeo.
 * @FileName: 2022_09_06_122116_create_geo_governorates_table.php.
 ******************************************************************************/
...
return new class extends Migration {
     ...
     * @var string
     */
    protected string $tableName = 'geo_governorates';
    ...
    public function morph(Blueprint $table): void
    {
        ...
        if (!Schema::hasColumn($tableName, 'geo_governorate_id')){$table->unsignedInteger("geo_governorate_id")->unique()->index();}
        ...
        if (!Schema::hasColumn($tableName, 'code')){$table->char("code", 8)->index();}
    ...
    public function down(): void
    {
        ...
        Schema::table($tableName, function (Blueprint $table) use ($tableName) {
            if (Schema::hasColumn($tableName, 'geo_governorate_id')) {$table->dropColumn('geo_governorate_id');}
